...
- `main.cpp`: initializes the board LED, initializes the `GPIO`, `MUX`, and `LEDS` classes, and runs a simple LED chase pattern
...
- The current discrete GPIO state is logged periodically as a bitmask for the configured encoder inputs.
